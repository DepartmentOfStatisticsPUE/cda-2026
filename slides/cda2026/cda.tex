...
OLS assumes residuals are continuous and Gaussian.
...
\medskip
A Gaussian likelihood cannot describe this shape. Even when point estimates look OK, likelihood-based inference (likelihood ratio tests, AIC, prediction intervals) is invalid.
